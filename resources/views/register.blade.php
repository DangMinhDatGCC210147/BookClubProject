                            ...
                            <div class="login-register-form">
                                <form action="" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 mb-20">
                                            <input class="form-control" type="text" name="idSt" id="idSt" placeholder="Student ID">
                                        </div>
                                        <div class="col-12 mb-20">
                                        ...
                                        <div class="col-12 mt-10">
                                            <button type="submit" class="button button-primary button-outline">Sign up</button>
                                        </div>
                                    </div>
                                </form>                                
                            </div>
