...
Route::middleware(['autoLogout'])->group(function () {
    ...
    Route::get('/post', [IndexController::class, 'post'])->name('user.post');
    Route::get('/post/{id}', [PostController::class, 'postdetail'])->name('user.post-detail');
    // ========================LEADERS===========================
    ...
    Route::post('/posts/{postId}/toggle-like', [PostController::class, 'toggleLike'])->name('toggle-like');
