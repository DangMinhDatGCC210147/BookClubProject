...
<head>
    ...
    <title>BookClub - Input Email</title>
                                ...
                                <form action="{{ route('password.email') }}" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-12 mb-20">
                                            <input class="form-control" id="email" type="email" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="Email FPT">
                                        </div>
                                        <div class="col-12 mt-10"><button type="submit" class="button button-primary button-outline">Send Password Reset Link</button></div>
                                    </div>
                                </form>                                
                            </div>
                        </div>
